        ...
        <div class="navbar-info d-flex align-items-center">
            ...
            <nav class="navbar navbar-expand">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link <?php echo $current_page === 'admin.php' ? 'active' : ''; ?>" href="admin.php">Quản lý</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo $current_page === 'statistics.php' ? 'active' : ''; ?>" href="statistics.php">Thống kê</a></li>
                </ul>
            </nav>
            <div class="dropdown-menu logo-dropdown" id="logoDropdown">
                <a class="nav-link <?php echo $current_page === 'admin.php' ? 'active' : ''; ?>" href="admin.php">Quản lý</a>
                <a class="nav-link <?php echo $current_page === 'statistics.php' ? 'active' : ''; ?>" href="statistics.php">Thống kê</a>
