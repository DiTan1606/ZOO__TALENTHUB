    ...
    <div class="container d-flex justify-content-between align-items-center">
        <div class="navbar-info d-flex align-items-center">
            ...
            <nav class="navbar navbar-expand">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link <?php echo $current_page === 'company.php' ? 'active' : ''; ?>" href="company.php">Thông tin</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo $current_page === 'recruiter.php' ? 'active' : ''; ?>" href="recruiter.php">Tuyển dụng</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo $current_page === 'interview_management.php' ? 'active' : ''; ?>" href="interview_management.php">Phỏng vấn</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo $current_page === 'test_management.php' ? 'active' : ''; ?>" href="test_management.php">Kiểm tra</a></li>
                </ul>
            </nav>
            <div class="dropdown-menu logo-dropdown" id="logoDropdown">
                <a class="nav-link <?php echo $current_page === 'company.php' ? 'active' : ''; ?>" href="company.php">Công ty</a>
                <a class="nav-link <?php echo $current_page === 'recruiter.php' ? 'active' : ''; ?>" href="recruiter.php">Tuyển dụng</a>
                <a class="nav-link <?php echo $current_page === 'interview_management.php' ? 'active' : ''; ?>" href="interview_management.php">Phỏng vấn</a>
                <a class="nav-link <?php echo $current_page === 'test_management.php' ? 'active' : ''; ?>" href="test_management.php">Kiểm tra</a>
        ...
        <div class="user-info d-flex align-items-center">
            ...
            <div class="user-info-content">
                <span class="user-name me-2"><?php echo ("Nhà tuyển dụng "). htmlspecialchars($name); ?></span>
